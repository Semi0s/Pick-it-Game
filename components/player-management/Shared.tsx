    ...
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="truncate text-base font-black text-gray-950">{title}</p>
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <ManagementBadge label={badge} tone={tone === "accent" ? "accent" : "neutral"} />
      </div>
      <p className="mt-3 text-sm font-semibold leading-6 text-gray-600">{copy}</p>
    </div>
  );
}
